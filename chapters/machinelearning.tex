...
To verify that the model learns physically meaningful features, the score response is evaluated differential in key VBS-sensitive observables. In particular, the score distributions are examined in bins of dijet invariant mass \(m_{jj}\), rapidity separation \(\Delta y_{jj}\), and large-\(R\) jet transverse momentum.